  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Dedicated tab for photo libraries — detects RAW+JPEG pairs, renders embedded previews from NEF, CR2, ARW, DNG and more, and protects Lightroom-tracked files from accidental deletion.",
      },
      {
